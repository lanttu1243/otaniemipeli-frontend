...
__export(index_exports, {
  AlertOctagonIcon: () => import_lucide_react.AlertOctagonIcon,
  AlertTriangleIcon: () => import_lucide_react.AlertTriangleIcon,
  AtSignIcon: () => import_lucide_react.AtSignIcon,
  BanknoteIcon: () => import_lucide_react.BanknoteIcon,
  BookMarkedIcon: () => import_lucide_react.BookMarkedIcon,
  BriefcaseBusinessIcon: () => import_lucide_react.BriefcaseBusinessIcon,
  Button: () => Button,
  Card: () => Card,
  Checkbox: () => Checkbox,
  ChevronDownIcon: () => import_lucide_react.ChevronDownIcon,
  ChevronLeftIcon: () => import_lucide_react.ChevronLeftIcon,
  ChevronRightIcon: () => import_lucide_react.ChevronRightIcon,
  ChevronUpIcon: () => import_lucide_react.ChevronUpIcon,
  ChevronsUpDownIcon: () => import_lucide_react.ChevronsUpDownIcon,
  CircleIcon: () => import_lucide_react.CircleIcon,
  ClockIcon: () => import_lucide_react.ClockIcon,
  Collapsible: () => Collapsible,
  CollapsibleContent: () => CollapsibleContent2,
  CollapsibleTrigger: () => CollapsibleTrigger2,
  ExternalLinkIcon: () => import_lucide_react.ExternalLinkIcon,
  FacebookIcon: () => import_react_simple_icons.SiFacebook,
  FileIcon: () => import_lucide_react.FileIcon,
  GavelIcon: () => import_lucide_react.GavelIcon,
  GithubIcon: () => import_react_simple_icons.SiGithub,
  GmailIcon: () => import_react_simple_icons.SiGmail,
  HandshakeIcon: () => import_lucide_react.HandshakeIcon,
  HelpCircleIcon: () => import_lucide_react.HelpCircleIcon,
  ImageIcon: () => import_lucide_react.ImageIcon,
  InboxIcon: () => import_lucide_react.InboxIcon,
  Input: () => Input,
  InstagramIcon: () => import_react_simple_icons.SiInstagram,
  LanguagesIcon: () => import_lucide_react.LanguagesIcon,
  LinkedinIcon: () => import_react_simple_icons.SiLinkedin,
  MailIcon: () => import_lucide_react.MailIcon,
  MapPinIcon: () => import_lucide_react.MapPinIcon,
  MegaphoneIcon: () => import_lucide_react.MegaphoneIcon,
  MenuIcon: () => import_lucide_react.MenuIcon,
  MoreHorizontalIcon: () => import_lucide_react.MoreHorizontalIcon,
  NavApplicantsIcon: () => applicants_default,
  NavCompaniesIcon: () => companies_default,
  NavEventsIcon: () => events_default,
  NavFuksisIcon: () => fuksis_default,
  NavGuildIcon: () => guild_default,
  ...
  PhoneIcon: () => import_lucide_react.PhoneIcon,
  Progress: () => Progress,
  Radio: () => Radio,
  RenderIcon: () => RenderIcon,
  ScrollArea: () => ScrollArea,
  ScrollBar: () => ScrollBar,
  SendIcon: () => import_lucide_react.SendIcon,
  Separator: () => Separator,
  Sheet: () => Sheet,
  ...
  TelegramIcon: () => import_react_simple_icons.SiTelegram,
  Textarea: () => Textarea,
  TikLogo: () => tik_logo_default,
  TiktokIcon: () => import_react_simple_icons.SiTiktok,
...
var cn = (...inputs) =>
  (0, import_tailwind_merge.twMerge)((0, import_clsx.clsx)(inputs));
...
var Card = React2.forwardRef(({ className, asChild, ...props }, ref) => {
  const Comp = asChild ? import_react_slot2.Slot : "div";
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Comp, {
    className: cn(
...
var Checkbox = React3.forwardRef(({ className, ...props }, ref) =>
...
var NavigationMenuPrimitive = __toESM(
...
// lib/icons/index.tsx
var import_react_simple_icons = require("@icons-pack/react-simple-icons");
  ...
  (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("svg", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("path", {
          d: "M59.87,17.44c-1.52-5.66-2.71-8.98-8.26-9.31-5.55-.32-8.59,4.14-8.81,7.83-.49.44-1.91.82-2.01,2.67-.06.92-.11,1.85,1.19,3.32,1.22,3.87,1.74,9.84,7.72,10.66,5.98.81,6.76-7.4,8.87-8.76,1.85.11,2.45-2.17,2.5-3.1.08-1.3.16-2.77-1.2-3.31ZM47.91,20.08c-.73-.04-1.28-.86-1.23-1.83.06-.97.69-1.73,1.42-1.69.73.04,1.28.86,1.23,1.84-.06.97-.69,1.72-1.42,1.68ZM54.11,20.79c-.73-.04-1.28-.86-1.23-1.84.06-.97.69-1.73,1.42-1.69.73.05,1.28.87,1.23,1.84-.06.97-.69,1.73-1.42,1.69Z",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("path", {
          d: "M4.026,31.679c1.706-2.124,4.924-2.195,6.77-.192,2.456,2.664,4.487,6.513,6.204,6.513,2,0,6-9.927,8.5-9.957,3.5-.043,5.5,4.32,6.5,8.139.844,3.224.976,14.415.996,17.825.003.564-.429,1.029-.991,1.075l-26.979,2.194c-.575.047-1.084-.361-1.156-.933-.443-3.507-1.87-15.119-1.87-19.342s.953-3.984,2.026-5.321Z",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("path", {
          d: "M59.279,30.777c-.734-.576-1.752-.619-2.542-.124-2.972,1.863-7.08,7.655-7.871,7.655-.942,0-5.654-9.061-8.01-9.1s-5.183,3.948-6.125,7.438c-.713,2.642-.887,11.142-.929,15.115-.012,1.175.888,2.154,2.059,2.247l23.138,1.825c1.188.094,2.24-.757,2.391-1.94.523-4.094,1.61-13.028,1.61-16.499,0-3.22-2.339-5.532-3.721-6.617Z",
        }),
      ],
    }),
);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", {
          d: "M16.06,12.473c-.287,0-.578-.062-.854-.193-.998-.473-1.424-1.665-.952-2.664C16.898,4.031,22.21.452,28.117.276c6.649-.176,10.977,4.026,12.147,5.325.74.82.674,2.085-.146,2.824-.82.74-2.086.674-2.824-.146-.627-.695-4.047-4.146-9.058-4.005-4.397.131-8.37,2.833-10.368,7.054-.342.722-1.06,1.145-1.809,1.145Z",
        }),
      ],
    }),
);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", {
          d: "M33.002,51.373c-.298,0-.602-.045-.9-.139-1.581-.497-2.459-2.182-1.962-3.762l3.98-12.665-7.53,1.506c-1.625.327-3.205-.728-3.53-2.354-.325-1.624.729-3.205,2.354-3.53l12.5-2.5c1.038-.208,2.112.149,2.819.937.709.789.948,1.893.631,2.904l-5.5,17.5c-.403,1.281-1.586,2.102-2.861,2.102Z",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", {
          d: "M15.799,19.758c-1.41,0-2.667-.999-2.943-2.435l-1.775-9.244c-.312-1.627.753-3.2,2.38-3.512,1.629-.313,3.199.753,3.512,2.38l1.775,9.244c.312,1.627-.753,3.2-2.38,3.512-.191.037-.382.054-.569.054Z",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", {
          d: "M60.451,51.332l-5.99-32.96c0-.02-.01-.03-.01-.05,0-.01-.01-.03-.01-.04l-1.99-10.95c-.29-1.63-1.86-2.7-3.49-2.41s-2.71,1.86-2.41,3.49l1.47,8.06-11.93,2.21-1.65-8.79c-.3-1.58-1.79-2.65-3.37-2.42l-7,1c-.8.12-1.53.55-2,1.21-.48.65-.67,1.47-.54,2.27l1.57,9.15-12.36,2.3-1.29-7.07c-.3-1.63-1.86-2.71-3.49-2.41-1.63.29-2.71,1.86-2.41,3.49l8,44c.14.79.6,1.5,1.28,1.95.49.33,1.08.51,1.67.51.21,0,.41-.02.61-.06l43-9c1.6-.34,2.63-1.88,2.34-3.48ZM16.901,57.302l-5.09-27.99,37.28-6.94,4.94,27.16-37.13,7.77Z",
        }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", {
          d: "M40.921,15.373c-1.41,0-2.667-.999-2.943-2.435l-1.775-9.244c-.312-1.627.753-3.2,2.381-3.512,1.621-.313,3.198.753,3.512,2.38l1.775,9.244c.312,1.627-.753,3.2-2.381,3.512-.19.037-.381.054-.568.054Z",
        }),
      ],
    }),
);
...
var icons = {
  AlertOctagon: import_lucide_react.AlertOctagonIcon,
  AlertTriangle: import_lucide_react.AlertTriangleIcon,
  AtSign: import_lucide_react.AtSignIcon,
  Banknote: import_lucide_react.BanknoteIcon,
  BookMarked: import_lucide_react.BookMarkedIcon,
  BriefcaseBusiness: import_lucide_react.BriefcaseBusinessIcon,
  ChevronDown: import_lucide_react.ChevronDownIcon,
  Chevronleft: import_lucide_react.ChevronLeftIcon,
  ChevronRight: import_lucide_react.ChevronRightIcon,
  ChevronsUpDown: import_lucide_react.ChevronsUpDownIcon,
  ChevronUp: import_lucide_react.ChevronUpIcon,
  Circle: import_lucide_react.CircleIcon,
  Clock: import_lucide_react.ClockIcon,
  ExternalLink: import_lucide_react.ExternalLinkIcon,
  Facebook: import_react_simple_icons.SiFacebook,
  File: import_lucide_react.FileIcon,
  Gavel: import_lucide_react.GavelIcon,
  Github: import_react_simple_icons.SiGithub,
  Gmail: import_react_simple_icons.SiGmail,
  HelpCircle: import_lucide_react.HelpCircleIcon,
  Image: import_lucide_react.ImageIcon,
  Inbox: import_lucide_react.InboxIcon,
  Instagram: import_react_simple_icons.SiInstagram,
  Languages: import_lucide_react.LanguagesIcon,
  Linkedin: import_react_simple_icons.SiLinkedin,
  Mail: import_lucide_react.MailIcon,
  MapPin: import_lucide_react.MapPinIcon,
  Megaphone: import_lucide_react.MegaphoneIcon,
  Menu: import_lucide_react.MenuIcon,
  MoreHorizontal: import_lucide_react.MoreHorizontalIcon,
  PaperAirplane: import_lucide_react.SendIcon,
  Phone: import_lucide_react.PhoneIcon,
  Telegram: import_react_simple_icons.SiTelegram,
  TikLogo: tik_logo_default,
  Tiktok: import_react_simple_icons.SiTiktok,
  X: import_lucide_react.XIcon,
  ...
  Handshake: import_lucide_react.HandshakeIcon,
};
function RenderIcon({ name, ...props }) {
  var _a;
  const IconComponent = (_a = icons[name]) != null ? _a : icons.HelpCircle;
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IconComponent, {
    ...props,
  });
}
...
var NavigationMenuList = React10.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(NavigationMenuPrimitive.List, {
    className: cn(
...
var NavigationMenuTrigger = React10.forwardRef(
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            import_lucide_react.ChevronDownIcon,
            {
              "aria-hidden": "true",
              className:
                "relative top-px ml-1 size-6 transition duration-200 group-data-[state=open]:rotate-180",
            },
          ),
        ],
      },
...
var NavigationMenuContent = React10.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
...
var NavigationMenuViewport = React10.forwardRef(
  ({ className, ...props }, ref) =>
...
var NavigationMenuIndicator = React10.forwardRef(
  ({ className, ...props }, ref) =>
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      NavigationMenuPrimitive.Indicator,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", {
          className:
            "relative top-[60%] size-2 rotate-45 rounded-tl-sm bg-gray-900 shadow-md",
        }),
      },
    ),
);
...
var ScrollArea = React11.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(ScrollAreaPrimitive.Root, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        ...
        { className: "size-full rounded-[inherit]", children },
      ),
...
var ScrollBar = React11.forwardRef(
...
var Separator = React12.forwardRef(
  (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SeparatorPrimitive.Root, {
      className: cn(
...
function SheetPortal(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetPrimitive.Portal, {
    ...props,
  });
}
SheetPortal.displayName = SheetPrimitive.Portal.displayName;
var SheetOverlay = React13.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetPrimitive.Overlay, {
    className: cn(
...
var SheetContent = React13.forwardRef(
  (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(SheetPortal, {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetOverlay, {}),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(SheetPrimitive.Content, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
              ...
              {
                className:
                  "absolute right-4 top-4 -m-2 rounded-full p-2 hover:bg-gray-300 focus:ring-2 focus:ring-gray-900 focus-visible:outline-none disabled:pointer-events-none data-[state=open]:bg-gray-900",
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", {
                    className: "sr-only",
                    children: closeLabel != null ? closeLabel : "Close",
                  }),
                ],
              },
            ),
...
var SheetTitle = React13.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetPrimitive.Title, {
...
var SheetDescription = React13.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetPrimitive.Description, {
...
var TabsTrigger = React14.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TabsPrimitive.Trigger, {
    className: cn(
...
var Textarea = React15.forwardRef(({ className, ...props }, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("textarea", {
    className: cn(
...
var Progress = React16.forwardRef(({ className, value, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(ProgressPrimitive.Root, {
    ref,
    className: cn(
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      ProgressPrimitive.Indicator,
      {
        ...
        style: {
          transform: `translateX(-${(100 - (value != null ? value : 0)).toFixed()}%)`,
        },
      },
    ),
  }),
  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        mono: ["Roboto Mono", ...import_defaultTheme.default.fontFamily.mono],
      },
      colors: {
        primary: {
...
var plugin = (0, import_plugin.default)(({ addUtilities, matchUtilities }) => {
  matchUtilities({
    "content-alt": (value) => ({
