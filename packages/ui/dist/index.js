...
var NavEventsIcon = React8.forwardRef(
  ({
    ...
    "svg",
    {
      ...
      ref,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M33.002,51.373c-.298,0-.602-.045-.9-.139-1.581-.497-2.459-2.182-1.962-3.762l3.98-12.665-7.53,1.506c-1.625.327-3.205-.728-3.53-2.354-.325-1.624.729-3.205,2.354-3.53l12.5-2.5c1.038-.208,2.112.149,2.819.937.709.789.948,1.893.631,2.904l-5.5,17.5c-.403,1.281-1.586,2.102-2.861,2.102Z" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M15.799,19.758c-1.41,0-2.667-.999-2.943-2.435l-1.775-9.244c-.312-1.627.753-3.2,2.38-3.512,1.629-.313,3.199.753,3.512,2.38l1.775,9.244c.312,1.627-.753,3.2-2.38,3.512-.191.037-.382.054-.569.054Z" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M60.451,51.332l-5.99-32.96c0-.02-.01-.03-.01-.05,0-.01-.01-.03-.01-.04l-1.99-10.95c-.29-1.63-1.86-2.7-3.49-2.41s-2.71,1.86-2.41,3.49l1.47,8.06-11.93,2.21-1.65-8.79c-.3-1.58-1.79-2.65-3.37-2.42l-7,1c-.8.12-1.53.55-2,1.21-.48.65-.67,1.47-.54,2.27l1.57,9.15-12.36,2.3-1.29-7.07c-.3-1.63-1.86-2.71-3.49-2.41-1.63.29-2.71,1.86-2.41,3.49l8,44c.14.79.6,1.5,1.28,1.95.49.33,1.08.51,1.67.51.21,0,.41-.02.61-.06l43-9c1.6-.34,2.63-1.88,2.34-3.48ZM16.901,57.302l-5.09-27.99,37.28-6.94,4.94,27.16-37.13,7.77Z" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M40.921,15.373c-1.41,0-2.667-.999-2.943-2.435l-1.775-9.244c-.312-1.627.753-3.2,2.381-3.512,1.621-.313,3.198.753,3.512,2.38l1.775,9.244c.312,1.627-.753,3.2-2.381,3.512-.19.037-.381.054-.568.054Z" })
      ]
    }
  )
);
...
var NavApplicantsIcon = React9.forwardRef(
  ({
    ...
    xmlns = "http://www.w3.org/2000/svg",
    ...rest
  }, ref) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "svg",
    {
      fill,
      height,
      ...
      ref,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M28.179,12.717c-.11-.442-.469-.774-.92-.84-1.572-.232-3.26-.877-9.26.123s-7.924,1.476-9.89,1.812c-.615.105-1.022.69-.913,1.305l5.616,31.826c.104.59.645.996,1.239.923,2.224-.273,7.566-.865,12.08-.865,4.303,0,7.14.538,8.88.825.651.107,1.31-.009,1.886-.331,1.987-1.108,7.761-3.714,10.101-4.494,1.949-.65,5.587-1.3,7.897-1.675,1.156-.188,1.933-1.288,1.73-2.441l-5.372-30.442c-.153-.866-.854-1.526-1.728-1.616-2.272-.233-6.666.459-9.526,1.174-3.229.807-7.762,2.57-9.389,3.605-.376.239-.569.673-.503,1.114l2.892,18.282-4.821-18.283Z" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M54.769,11.744l1.182-.394c.552-.184,1.14.166,1.241.739l5.642,31.973c.091.518-.254,1.013-.773,1.105l-21.187,3.76c-.665.091-.864-.874-.217-1.053l17.508-4.651c.474-.126.775-.59.697-1.074l-4.733-29.348c-.074-.461.197-.909.64-1.057Z" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M4.176,20.275l-.746.249c-.82.273-1.315,1.108-1.16,1.959l5.597,30.783c.074.408.461.682.871.616l21.98-2.757c.948-.152.804-1.558-.155-1.514l-18.904,1.359c-.378.017-.711-.245-.783-.617l-5.71-29.5c-.088-.452-.553-.724-.99-.578Z" })
      ]
    }
  )
);
...
function RenderIcon({ name, ...props }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IconComponent, { ...props });
}

// lib/components/navigation-menu/index.tsx
var import_jsx_runtime11 = require("react/jsx-runtime");
var NavigationMenu = React10.forwardRef(({ className, children, delayDuration = 0, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
  NavigationMenuPrimitive.Root,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(NavigationMenuViewport, {})
    ]
  }
));
NavigationMenu.displayName = NavigationMenuPrimitive.Root.displayName;
var NavigationMenuList = React10.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
...
var NavigationMenuTrigger = React10.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
...
var NavigationMenuContent = React10.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
...
var NavigationMenuViewport = React10.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: cn("absolute left-0 top-full flex w-full justify-center"), children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
...
var NavigationMenuIndicator = React10.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
  NavigationMenuPrimitive.Indicator,
  {
    ...
    ref,
    ...props,
    children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "relative top-[60%] size-2 rotate-45 rounded-tl-sm bg-gray-900 shadow-md" })
  }
));
...
var ScrollArea = React11.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
  ScrollAreaPrimitive.Root,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ScrollAreaPrimitive.Viewport, { className: "size-full rounded-[inherit]", children }),
...
var ScrollBar = React11.forwardRef(({ className, orientation = "vertical", ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
  ScrollAreaPrimitive.ScrollAreaScrollbar,
  {
    ...
    ref,
    ...props,
    children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ScrollAreaPrimitive.ScrollAreaThumb, { className: "relative flex-1 rounded-full bg-gray-900" })
  }
));
...
function SheetPortal(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SheetPrimitive.Portal, { ...props });
}
...
var SheetContent = React13.forwardRef(
  ({
    ...
    children,
    ...props
  }, ref) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(SheetPortal, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      SheetPrimitive.Content,
      {
        ...
        children: [
          children,
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(SheetPrimitive.Close, { className: "absolute right-4 top-4 -m-2 rounded-full p-2 hover:bg-gray-300 focus:ring-2 focus:ring-gray-900 focus-visible:outline-none disabled:pointer-events-none data-[state=open]:bg-gray-900", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_lucide_react.XIcon, { className: "size-6" }),
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "sr-only", children: closeLabel != null ? closeLabel : "Close" })
          ] })
        ]
      }
    )
...
var Progress = React16.forwardRef(({ className, value, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
